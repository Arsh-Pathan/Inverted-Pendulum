...
def convert_fcstd_to_stl(fcstd_path="models/assembly_model.FCStd"):
    """
    Converts assembly_model.FCStd shapes directly into STL mesh files using
    FreeCAD 1.1's native Python engine or freecadcmd process execution.
    """
...
"""
        ...
        try:
            print(f"[FreeCAD 1.1] Executing native FreeCAD engine on {fcstd_path}...")
